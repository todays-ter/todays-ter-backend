...
public enum AuthErrorCode implements BaseCode {
    ...
    APPLE_IDENTITY_TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "AUTH401_9", "유효하지 않은 애플 Identity Token입니다."),
    APPLE_PUBLIC_KEY_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH401_10", "애플 Identity Token에 해당하는 공개키를 찾을 수 없습니다."),
    ...
    APPLE_USER_ID_MISSING(HttpStatus.BAD_GATEWAY, "AUTH502_5", "애플 사용자 식별 정보를 확인할 수 없습니다."),
    APPLE_PUBLIC_KEY_FAILED(HttpStatus.BAD_GATEWAY, "AUTH502_6", "애플 공개키를 조회하거나 생성하지 못했습니다.")
    ;
