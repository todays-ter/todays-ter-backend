...
public enum MemberSuccessCode implements BaseCode {
    ...
    CONCERNS_UPDATED(HttpStatus.OK, "MEMBER200_4", "고민 유형이 수정되었습니다."),
    MEMBER_INFO_RETRIEVED(HttpStatus.OK, "MEMBER200_5", "회원 정보를 조회했습니다."),
    SOCIAL_ACCOUNTS_RETRIEVED(HttpStatus.OK, "MEMBER200_6", "연결된 소셜 계정을 조회했습니다."),
    MEMBER_WITHDRAWN(HttpStatus.OK, "MEMBER200_7", "회원 탈퇴가 완료되었습니다.")
    ;
